...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-black/40 backdrop-blur-md p-6 text-white shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
